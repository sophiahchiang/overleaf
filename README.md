...
Andrew Zhang's Medium article on how to build a Markdown editor was extremely helpful. Similarly, I frequently referenced the iOS list app we worked on in class for the file system framework as well as Swift documentation.  
